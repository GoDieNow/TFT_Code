...
// NewUDRManagementAPIAPI creates a new UDRManagementAPI instance
func NewUDRManagementAPIAPI(spec *loads.Document) *UDRManagementAPIAPI {
	return &UDRManagementAPIAPI{
		...
		TriggerManagementExecCompactationHandler: trigger_management.ExecCompactationHandlerFunc(func(params trigger_management.ExecCompactationParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation trigger_management.ExecCompactation has not yet been implemented")
		}),
		MetricsManagementGetMetricsHandler: metrics_management.GetMetricsHandlerFunc(func(params metrics_management.GetMetricsParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation metrics_management.GetMetrics has not yet been implemented")
		}),
...
/*UDRManagementAPIAPI An API which supports creation, deletion, listing etc of UDR */
type UDRManagementAPIAPI struct {
	spec            *loads.Document
	...
	// TriggerManagementExecCompactationHandler sets the operation handler for the exec compactation operation
	TriggerManagementExecCompactationHandler trigger_management.ExecCompactationHandler
	// MetricsManagementGetMetricsHandler sets the operation handler for the get metrics operation
	MetricsManagementGetMetricsHandler metrics_management.GetMetricsHandler
...
func (o *UDRManagementAPIAPI) UseRedoc() {
	o.useSwaggerUI = false
}

// UseSwaggerUI for documentation at /docs
func (o *UDRManagementAPIAPI) UseSwaggerUI() {
	o.useSwaggerUI = true
}

// SetDefaultProduces sets the default produces media type
func (o *UDRManagementAPIAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *UDRManagementAPIAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *UDRManagementAPIAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *UDRManagementAPIAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *UDRManagementAPIAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *UDRManagementAPIAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *UDRManagementAPIAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the UDRManagementAPIAPI
func (o *UDRManagementAPIAPI) Validate() error {
	...
	if o.TriggerManagementExecCompactationHandler == nil {
		unregistered = append(unregistered, "trigger_management.ExecCompactationHandler")
	}
	if o.MetricsManagementGetMetricsHandler == nil {
		unregistered = append(unregistered, "metrics_management.GetMetricsHandler")
	}
...
func (o *UDRManagementAPIAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *UDRManagementAPIAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *UDRManagementAPIAPI) Authorizer() runtime.Authorizer {
	return o.APIAuthorizer
}

// ConsumersFor gets the consumers for the specified media types.
// MIME type parameters are ignored here.
func (o *UDRManagementAPIAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
// MIME type parameters are ignored here.
func (o *UDRManagementAPIAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *UDRManagementAPIAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the u d r management API API
func (o *UDRManagementAPIAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *UDRManagementAPIAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/trigger/compact"] = trigger_management.NewExecCompactation(o.context, o.TriggerManagementExecCompactationHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/metrics"] = metrics_management.NewGetMetrics(o.context, o.MetricsManagementGetMetricsHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
...
func (o *UDRManagementAPIAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *UDRManagementAPIAPI) Init() {
	if len(o.handlers) == 0 {
		o.initHandlerCache()
	}
}
...
func (o *UDRManagementAPIAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *UDRManagementAPIAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
	o.customProducers[mediaType] = producer
}

// AddMiddlewareFor adds a http middleware to existing handler
func (o *UDRManagementAPIAPI) AddMiddlewareFor(method, path string, builder middleware.Builder) {
	um := strings.ToUpper(method)
	if path == "/" {
		path = ""
	}
