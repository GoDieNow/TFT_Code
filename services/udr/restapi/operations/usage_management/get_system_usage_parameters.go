...
func (o *GetSystemUsageParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	qIdlist, qhkIdlist, _ := qs.GetOK("idlist")
	if err := o.bindIdlist(qIdlist, qhkIdlist, route.Formats); err != nil {
		res = append(res, err)
	}
...
func (o *GetSystemUsageParams) validateFrom(formats strfmt.Registry) error {
...
// bindIdlist binds and validates parameter Idlist from query.
func (o *GetSystemUsageParams) bindIdlist(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSystemUsageParams) bindMetric(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSystemUsageParams) validateTo(formats strfmt.Registry) error {
