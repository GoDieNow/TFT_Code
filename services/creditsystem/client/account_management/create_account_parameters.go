...
// WithID adds the id to the create account params
func (o *CreateAccountParams) WithID(id string) *CreateAccountParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the create account params
func (o *CreateAccountParams) SetID(id string) {
	o.ID = id
}
