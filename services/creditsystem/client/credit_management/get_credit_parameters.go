...
// WithID adds the id to the get credit params
func (o *GetCreditParams) WithID(id string) *GetCreditParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get credit params
func (o *GetCreditParams) SetID(id string) {
	o.ID = id
}
