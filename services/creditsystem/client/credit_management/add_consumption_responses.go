...
func (o *AddConsumptionOK) Error() string {
	return fmt.Sprintf("[POST /{medium}/consume/{id}][%d] addConsumptionOK  %+v", 200, o.Payload)
}
...
func (o *AddConsumptionNotFound) Error() string {
	return fmt.Sprintf("[POST /{medium}/consume/{id}][%d] addConsumptionNotFound  %+v", 404, o.Payload)
}
...
func (o *AddConsumptionInternalServerError) Error() string {
	return fmt.Sprintf("[POST /{medium}/consume/{id}][%d] addConsumptionInternalServerError  %+v", 500, o.Payload)
}
