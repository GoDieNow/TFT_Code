...
type ListAccountsHandlerFunc func(ListAccountsParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ListAccountsHandlerFunc) Handle(params ListAccountsParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// ListAccountsHandler interface for that can handle valid list accounts params
type ListAccountsHandler interface {
	Handle(ListAccountsParams, interface{}) middleware.Responder
}
...
/*ListAccounts swagger:route GET /account/list accountManagement listAccounts

List of the accounts in the system
