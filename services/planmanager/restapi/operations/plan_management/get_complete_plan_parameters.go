...
// GetCompletePlanParams contains all the bound params for the get complete plan operation
...
func (o *GetCompletePlanParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
