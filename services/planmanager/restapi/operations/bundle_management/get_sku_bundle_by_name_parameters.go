...
// GetSkuBundleByNameParams contains all the bound params for the get sku bundle by name operation
...
func (o *GetSkuBundleByNameParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
