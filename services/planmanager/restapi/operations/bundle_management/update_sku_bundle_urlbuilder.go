...
func (o *UpdateSkuBundleURL) Build() (*url.URL, error) {
	...
	var _path = "/sku/bundle/{id}"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on UpdateSkuBundleURL")
	}
...
func (o *UpdateSkuBundleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateSkuBundleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateSkuBundleURL")
	}
