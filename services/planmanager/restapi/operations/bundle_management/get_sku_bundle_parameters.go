...
// GetSkuBundleParams contains all the bound params for the get sku bundle operation
...
func (o *GetSkuBundleParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
