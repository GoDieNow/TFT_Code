...
type AddProductHandlerFunc func(AddProductParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn AddProductHandlerFunc) Handle(params AddProductParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// AddProductHandler interface for that can handle valid add product params
type AddProductHandler interface {
	Handle(AddProductParams, interface{}) middleware.Responder
}
...
/*AddProduct swagger:route POST /product productManagement addProduct

Insert a new product in the system.
